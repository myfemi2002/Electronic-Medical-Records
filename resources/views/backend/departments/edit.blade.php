            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fa fa-building"></i> Update Department
                    </h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.departments.update', $department->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror"
                                        ...
                                        <option value="medical"
                                            {{ old('type', $department->type) == 'medical' ? 'selected' : '' }}>
                                            Medical
                                        </option>

                                        <option value="support"
                                            {{ old('type', $department->type) == 'support' ? 'selected' : '' }}>
                                            Support
                                        </option>

                                        <option value="administrative"
                                            {{ old('type', $department->type) == 'administrative' ? 'selected' : '' }}>
                                            Administrative
                                        </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="staff_ids">Assign Staff to Department</label>
                                    <select class="form-select @error('staff_ids') is-invalid @enderror"
                                            id="staff_ids"
                                            name="staff_ids[]"
                                            multiple>
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}"
                                                @if(isset($departmentStaff) && in_array($user->id, $departmentStaff)) selected @endif>
                                                {{ $user->name }}
                                                @if($user->staff_type)
                                                    ({{ ucfirst($user->staff_type) }})
                                                @endif
                                    ...
                                    <small class="form-text text-muted d-block">
                                        Hold CTRL (Windows) or CMD (Mac) to select multiple staff.
                                    </small>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="display_order"
                                           name="display_order"
                                           value="{{ old('display_order', $department->display_order) }}"
                                           min="0">
                                    @error('display_order')
                                      <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('can_receive_triage_patients', $department->can_receive_triage_patients) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input"
                                           ...
                                           value="1"
                                           {{ old('requires_appointment', $department->requires_appointment) ? 'checked' : '' }}>
