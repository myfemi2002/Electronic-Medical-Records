var kamr = function () {
   ...
   var b = function () {
      ...
      g = function () {
         for (var b = window.location, a = $("ul#menu a").filter(function () {
               return this.href == b
      ...
      j = function () {
         $('a[data-action="collapse"]').on("click", function (a) {
            a.preventDefault(), $(this).closest(".card").find('[data-action="collapse"] i').toggleClass("mdi-arrow-down mdi-arrow-up"), $(this).closest(".card").children(".card-body").collapse("toggle")
         }), $('a[data-action="expand"]').on("click", function (a) {
            a.preventDefault(), $(this).closest(".card").find('[data-action="expand"] i').toggleClass("icon-size-actual icon-size-fullscreen"), $(this).closest(".card").toggleClass("card-fullscreen")
         }), $('[data-action="close"]').on("click", function () {
            $(this).closest(".card").removeClass().slideUp("fast")
         }), $('[data-action="reload"]').on("click", function () {
            var a = $(this);
            a.parents(".card").addClass("card-load"), a.parents(".card").append('<div class="card-loader"><i class=" ti-reload rotate-refresh"></div>'), setTimeout(function () {
               a.parents(".card").children(".card-loader").remove(), a.parents(".card").removeClass("card-load")
            }, 2e3)
         })
      },
      k = function () {
         ...
         $(window).scroll(function () {
            "horizontal" === $("body").attr("data-layout") && "static" === $("body").attr("data-header-position") && "fixed" === $("body").attr("data-sidebar-position") && ($(this.window).scrollTop() >= a ? $(".deznav").addClass("fixed") : $(".deznav").removeClass("fixed"))
         })
      },
      l = function () {
      ...
      p = function () {
         $(".btn-number").on("click", function (c) {
            ...
            var a = $("input[name='" + fieldName + "']"),
               b = parseInt(a.val());
            isNaN(b) ? a.val(0) : "minus" == type ? a.val(b - 1) : "plus" == type && a.val(b + 1)
         })
      },
      q = function () {
      ...
      u = function () {
         $(".dz-load-more").on("click", function (a) {
            a.preventDefault(), $(this).append(' <i class="fa fa-refresh"></i>');
            var b = $(this).attr("rel"),
               c = $(this).attr("id");
            $.ajax({
               method: "POST",
               ...
               dataType: "html",
               success: function (a) {
                  $("#" + c + "Content").append(a), $(".dz-load-more i").remove()
               }
            })
         })
      },
      ...
      w = function () {
         $(".custom-file-input").on("change", function () {
            ...
            $(this).siblings(".custom-file-label").addClass("selected").html(a)
         })
      },
      x = function () {
      ...
      y = function () {
         new PerfectScrollbar(".dz-demo-content"), $(".dz-demo-trigger").on("click", function () {
      ...
      A = function () {
         jQuery("#ckeditor").length > 0 && ClassicEditor.create(document.querySelector("#ckeditor"), {}).then(a => {
            window.editor = a
         }).catch(a => {
...
jQuery(document).ready(function () {
   ...
   "use strict";
   kamr.load(), setTimeout(function () {
      kamr.handleMenuPosition()
   }, 1e3)
}), jQuery(window).on("resize", function () {
   "use strict";
   kamr.resize(), setTimeout(function () {
      kamr.handleMenuPosition()
   }, 1e3)
})